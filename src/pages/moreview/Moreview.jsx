  ...
  return (
    <>
      ...
      <div className="w-full px-4 sm:px-6 md:px-12 py-6">
        <div className={`flex ${isDesktop ? 'lg:flex-row' : 'flex-col'} w-full`}>
          {/* Sidebar */}
              ...
              <div className="border">
                ...
                <div className="mt-6 px-4">
                  ...
                  <div className="flex gap-4 px-8 mt-4 items-center justify-center">
                    ...
                    <button className="bg-[#F1F2F3] text-[#8A8A8A] text-xl font-normal px-8 py-2">
                      Max
                    </button>
                  </div>
                ...
                <div className="px-4 mb-4">
                  <label className="block font-semibold text-2xl underline">Size</label>
